...
package openfoodfacts.github.scrachx.openfood.api.v0

/**
 * This object lists all fields, field prefixes and suffixes and default values
 * used by the Open Food Facts API.
 *
 * We discourage the use of string literals through the code and we recommend
 * using fields defined here so that they can be updated on API changes.
 */
object ApiFields {
    ...
    object Keys {
        ...
        /**
         * Get the localized product name key for a given language code
         */
        fun lcProductNameKey(lang: String) = "${Prefix.PRODUCT_NAME}$lang"

        /**
         * Get the localized ingredients key for a given language code
         */
    ...
    /**
     * Get all fields for a product query, including localized fields
     * @param langCode The language code (e.g., "en", "fr", "it")
